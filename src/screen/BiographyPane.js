...
import { BiographyParagraph } from '../component/Paragraph';

const BiographyPane = () => {
  return (
    <PaneContainer id="biography">
      <Header as='h2'>Welcome To My Website!</Header>
      <Image src='images/jadon.png' size='medium' wrapped alt="Jadon" style={{float: "left", marginRight: 20}}/>
      <BiographyParagraph>
        I am Jadon Fan. I study Computer Engineering at the University of Waterloo in Ontario, Canada. I am part of 
        the graduating class of 2022 and currently in my fourth year of study. I am part of the University's 
        co-op program, which means that I alternate between study terms and work terms every 4 months. I hope 
        you enjoy exploring my website, which I am using to gain further experience in web development.
      </BiographyParagraph>
      <BiographyParagraph>
      ...
      <BiographyParagraph>
        ...
        <quote> while it is important to work hard, working smart is more efficient and effective</quote>. Meanwhile, my friends 
